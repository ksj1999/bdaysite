...
import ToBeyzaPage from "./ToBeyza";
...
const IndexPage = () => {
  ...
  const buttons = ["Main", "Wanna Talk?", "Photo", "Present", "Letter to Beyza"];
  ...
  return (
    <MainContainer> 
      ...
      {activeButton === "Wanna Talk?" && <ToBeyzaPage />}
      {activeButton === 'Photo' && <PhotoPage />} 
      {activeButton === 'Present' && <PresentPage />} 
      {activeButton === 'Letter to Beyza' && <LetterPage />} 
    </MainContainer>
  );
};
